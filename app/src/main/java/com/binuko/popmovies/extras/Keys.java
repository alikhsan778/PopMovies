package com.binuko.popmovies.extras;
...
public class Keys {
    ...
    public static final String KEY_VOTE_AVR = "vote_average";

    // Duration endpoint.
    public static final String KEY_DUR = "runtime";

    // Trailers endpoints.
    public static final String KEY_TUBE = "key";
